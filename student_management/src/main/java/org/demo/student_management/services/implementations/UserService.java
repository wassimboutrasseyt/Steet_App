        ...
        try {
            ...
            if (locationHeader != null && locationHeader.contains("/users/")) {
                ...
                ResponseEntity<List> usersResponse = restTemplate.exchange(
                        "http://localhost:8080/admin/realms/steet-app-realm/users?username=" + request.getUsername(),
            ...
            ResponseEntity<Void> pwdResponse = restTemplate.exchange(
                    "http://localhost:8080/admin/realms/steet-app-realm/users/" + userId + "/reset-password",
